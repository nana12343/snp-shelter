...
pub mod reference_value_provider_service_server {
    ...
    #[async_trait]
    pub trait ReferenceValueProviderService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct ReferenceValueProviderServiceServer<T: ReferenceValueProviderService> {
        inner: Arc<T>,
    ...
    impl<T: ReferenceValueProviderService> ReferenceValueProviderServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: ReferenceValueProviderService> Clone
    for ReferenceValueProviderServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
    ...
    impl<T: ReferenceValueProviderService> tonic::server::NamedService
    for ReferenceValueProviderServiceServer<T> {
        const NAME: &'static str = "reference.ReferenceValueProviderService";
    }
}
